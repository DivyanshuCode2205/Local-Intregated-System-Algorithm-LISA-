...
my_files = {"downloads": os.path.normpath("D:\Downloads"),
    ...
    "vs code":os.path.normpath(r"C:\Users\Divyanshu xd\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Visual Studio Code\Visual Studio Code.lnk"),
    ...
    "screenshots":os.path.normpath(os.path.join("D:\Pictures", 'Screenshot')),
    "wallpapers":os.path.normpath(os.path.join("D:\Pictures", "Wallpapers")),
    "local drive":os.path.normpath("C:/"), "d drive":os.path.normpath("D:/"),
